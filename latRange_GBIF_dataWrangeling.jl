...
### e.g. (note in expressions below, you have to use whichever quote you're not trying to get rid of—e.g., 's/\"//g' vs "s/\'//g"
### sed 's/\"//g' basidios_world_occurrence.csv > basidios_world_occurrence_1.csv ### just removes double quotes
### sed "s/\'//g" basidios_world_occurrence_1.csv > basidios_world_occurrence_noQuotes.csv ### removes single quotes from basidios_world_occurrence_1.csv
